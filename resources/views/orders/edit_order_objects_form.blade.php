...
<div class='form-group panel-body'>
    ...
    <div class='col-md-12 col-sm-12 form-select-control'>
            {!! Form::text('name'.$object->id ,$object->name,['class'=>'form-control', /*'multiple'=>'multiple' */]) !!}
    </div>
...
<div class='col-md-12 col-sm-12 form-select-control'>
        {!! Form::text('serial_number'.$object->id ,$object->serial_number,['class'=>'form-control', /*'multiple'=>'multiple' */]) !!}
</div>
...
<div class='col-md-12 col-sm-12 form-select-control'>
    {!! Form::text('diagnosis'.$object->id ,$object->diagnosis,['class'=>'form-control', /*'multiple'=>'multiple' */]) !!}
</div>
<div class='col-md-4 control-label'>
    {!! Form::label('fixed'.$object->id,'Naprawiono:') !!}
</div>
<div class='col-md-12 col-sm-12 form-select-control'>
        {!! Form::select('fixed'.$object->id ,array('1'=>'tak','0'=>'nie'),null,['class'=>'form-select-control select-2']) !!}
